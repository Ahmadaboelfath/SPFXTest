...
class AllPurchasingRequests extends React.Component<
...
> {
  ...
  componentDidMount(): void {
    this._purchaseRequestBusinessLogic.getAll().then((approvals) => {
...
export default withRouter(AllPurchasingRequests);
